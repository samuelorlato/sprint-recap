...
export default function SprintWrapped() {
  const pages = [
    ...
    icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="84" height="84" viewBox="0 0 24 24" fill="none" stroke="White" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-flame-icon lucide-flame"><path d="M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4"/></svg>
    ),
    iconClass: "icon-anim"
  },
 ...
 <svg xmlns="http://www.w3.org/2000/svg" width="74" height="74" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bug-icon lucide-bug"><path d="M12 20v-9"/><path d="M14 7a4 4 0 0 1 4 4v3a6 6 0 0 1-12 0v-3a4 4 0 0 1 4-4z"/><path d="M14.12 3.88 16 2"/><path d="M21 21a4 4 0 0 0-3.81-4"/><path d="M21 5a4 4 0 0 1-3.55 3.97"/><path d="M22 13h-4"/><path d="M3 21a4 4 0 0 1 3.81-4"/><path d="M3 5a4 4 0 0 0 3.55 3.97"/><path d="M6 13H2"/><path d="m8 2 1.88 1.88"/><path d="M9 7.13V6a3 3 0 1 1 6 0v1.13"/></svg>
...

  {
    type: "stats",
    icon: (
<svg xmlns="http://www.w3.org/2000/svg" width="74" height="74" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-down-icon lucide-trending-down"><path d="M16 17h6v-6"/><path d="m22 17-8.5-8.5-5 5L2 7"/></svg>
    ),
    iconClass: "rotate-text",
    number: "O profeta",
    numberClass: "small-label",
      ...
      <div className="text-center">
        ...
        <div className="mx-auto wrapped-card position-relative">
          <div className="card-body d-flex flex-column justify-content-center align-items-center h-100">
            ...
            {/* PRIMEIRA PÁGINA: igual o seu layout antigo */}
            {page.type === "intro" && (
              <>
        ...
        <div className="d-flex justify-content-between align-items-center mt-4 text-white">
          <span role="button" className="nav-btn" onClick={prevPage}>Anterior</span>
          <span>{index + 1} / {pages.length}</span>
          <span role="button" className="nav-btn" onClick={nextPage}>Próximo</span>
        </div>
      </div>
    </div>
  );
